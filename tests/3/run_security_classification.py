#!/usr/bin/env python3
"""
Security Classification Test Script for LLMKnowledge3

This script automates the complete workflow for security classification:
1. Creates a group for security classification
2. Uploads plain knowledge files (enterprise documents)
...
class SecurityClassification:
    ...
    def create_group(self):
        """Create a group for security classification"""
        print("📁 Creating Security Classification group...")
        
        group_data = {
            "name": "Security Classification Test",
            "description": "Automated security classification and risk assessment of enterprise documents"
        }
    ...
    def upload_plain_knowledge(self):
        """Upload enterprise document markdown files"""
        print("📄 Uploading enterprise document files...")
        ...
        print(f"✅ Uploaded {uploaded_count} enterprise document files")
    ...
    def create_matrix_definition(self):
        ...
        matrix_data = {
            "name": "Security Classification Matrix",
            "description": "Risk assessment and security classification matrix for enterprise documents",
    ...
    def download_excel(self):
        ...
        if response.status_code == 200:
            ...
            filename = f"security_classification_matrix_{timestamp}.xlsx"
    ...
    def run_complete_classification(self):
        """Run the complete security classification workflow"""
        print("=" * 60)
        print("🔒 SECURITY CLASSIFICATION TEST WORKFLOW")
        print("=" * 60)
        ...
        if not self.upload_plain_knowledge():
            return False
        
        if not self.create_prompts():
            return False
        
        if not self.execute_tasks():
            return False
        
        if not self.create_matrix_definition():
            return False
        ...
        print("=" * 60)
        print("🎉 SECURITY CLASSIFICATION TEST COMPLETED SUCCESSFULLY!")
        print("=" * 60)
        return True
